...
class Place():
    def __init__(self, given_name, next_places, start_text, other_text, enemies, searchable_objects, send_to_debris=False, locked=True):
...
Home = Place("home", None, None, None, None, None)
Orbit = Place("orbit", [], "welcome to orbit, write some more stuff", "what else would you like to do in orbit", [test_goon], [test_closet], False, False)
