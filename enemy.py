...
space_bandit = ("a space bandit", [fake_out, menacing_bark], 15, 13, 15, 10, "", None, None)
...
space_rock = Enemy("an evil space rock", [stand_there], 12, 10, 15, 10,
                    ...
                    None, None)
ominous_sattelite = Enemy("a very spoooooooky sattelite", [laser_beam], 10, 12, 7, 20, "This sattelite seems strange, time to kill it", blowtorch, None )
cheese_monster = Enemy("the cheese monster", [cheese_strike], 40, 15, 15, 10, "a fearful amalgamation of molten Wendslydale spew towards you, good luck trying to cheese this fight", hyperactive_cheese, None)
...
strange_ship = Enemy("a small strange ship", [stand_there], 50, 0, 40, 0, "It seems to be scanning you", None, ["Jupiter", "Uranus"])
